import { ChevronRight, HomeIcon, InfoIcon, BookmarkIcon, type LucideIcon } from "lucide-react"
...
export function NavMain() {
  ...
  const navItems = useMemo(() => {
    const items: NavItem[] = []
    const allRoutes = ['/', '/about', '/wishlist/overview', '/wishlist/personal']
      ...
      <SidebarMenu>
        {navItems.map((item) => {
          const isActive =
            ...
            (item.items?.some((subItem) => currentPath === subItem.path) ?? false)
