...
const items = [
	{ name: 'Tempo', ilvl: 684, subheader: 'Queen Ansurek / Weapon', dmgIncrease: 4.1 },
	{ name: 'Signet of the Priory', ilvl: 678, subheader: 'Dungeon / Ring', dmgIncrease: 2.8 },
];
			...
			<div className='mt-2 p-2 md:p-4'>
				<div className='mb-4 flex items-center justify-between'>
					<div className='flex items-center gap-2'>
						<h2 className='text-foreground text-lg font-medium'>Equipment</h2>
				...
				<div className='space-y-6'>
					<div className='space-y-2'>
						...
						<div className='grid grid-cols-1 gap-2 md:grid-cols-2'>
							{items.map((item) => (
								<WishlistPersonalItem key={item.name} item={item} />
							))}
						</div>
					</div>
				</div>
