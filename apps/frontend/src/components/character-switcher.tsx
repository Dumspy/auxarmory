        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              <div className="bg-sidebar-primary text-sidebar-primary-foreground flex aspect-square size-8 items-center justify-center rounded-lg">
                <activeCharacter.logo className="size-4" />
              </div>
              <div className="grid flex-1 text-left text-sm leading-tight">
                <span className="truncate font-medium">{activeCharacter.name}</span>
                <span className="truncate text-xs">{activeCharacter.class}</span>
              </div>
          ...
          >
            ...
            {characters.map((character, index) => (
              ...
              >
                <div className="flex size-6 items-center justify-center rounded-md border">
                  <character.logo className="size-3.5 shrink-0" />
                </div>
                {character.name}
            ...
            <DropdownMenuItem className="gap-2 p-2">
              ...
              <div className="text-muted-foreground font-medium">Sync characters</div>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </SidebarMenuItem>
