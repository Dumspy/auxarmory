...
import { KeyNameIdResponse, KeyResponse, LinkSelfResponse, LocaleResponse, MediaAssetArray, MediaKeyResponse } from "../../types";

export const CovenantIndexResponse = LinkSelfResponse.extend({
	covenants: z.array(KeyNameIdResponse)
})
export function CovenantIndex(this: WoWGameDataClient): Promise<z.infer<typeof CovenantIndexResponse>> {
	return this.request({
...
export const CovenantResponese = LinkSelfResponse.extend({
	...
	name: LocaleResponse,
	description: LocaleResponse,
	signature_ability: z.strictObject({
		id: z.number(),
		spell_tooltip: CovenantSpellTooltip,
	}).optional(),
	class_abilities: z.array(
		z.strictObject({
			id: z.number(),
...
export function Covenant(this: WoWGameDataClient, covenantId: number): Promise<z.infer<typeof CovenantResponese>> {
	return this.request({
...
export function CovenantMedia(this: WoWGameDataClient, covenantId: number): Promise<z.infer<typeof CovenantMediaResponse>> {
	return this.request({
...
export function CovenantSoulbindIndex(this: WoWGameDataClient): Promise<z.infer<typeof CovenantSoulbindIndexReponse>> {
	return this.request({
...
export function CovenantSoulbind(this: WoWGameDataClient, soulbindId: number): Promise<z.infer<typeof CovenantSoulbindResponse>> {
	return this.request({
...
export function CovenantConduitIndex(this: WoWGameDataClient): Promise<z.infer<typeof CovenantConduitIndexResponse>> {
	return this.request({
...
export function CovenantConduit(this: WoWGameDataClient, conduitId: number): Promise<z.infer<typeof CovenantConduitResponse>> {
	return this.request({
